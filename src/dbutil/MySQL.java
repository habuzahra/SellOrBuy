...
public class MySQL {
	...
	private final static String connectionURL = "jdbc:mysql://localhost:3306/buysell";
	...
	static {
		...
		dbProperties.setProperty("password", "Homealone!123");
		dbProperties.setProperty("useSSL", "false");
		dbProperties.setProperty("autoReconnect", "true");
		dbProperties.setProperty("allowPublicKeyRetrieval", "true");
		dbProperties.setProperty("useUnicode", "true");
		dbProperties.setProperty("useLegacyDatetimeCode", "false");
	...
	private Connection getConnection() {
		try {
			...
			System.out.println("DB Connection in Hand");
